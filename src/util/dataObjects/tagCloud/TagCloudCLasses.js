...
export const tagsForTheCloud = [
    ...
    'E-Commerce', 'Database Deployment', 
    'AI & Machine Learning', 'Prompt Engineering', 
    'Data-Driven BI', 'SaaS Development',
    'Networking & IT', 'Mobile App Development', 
    'AWS Cloud', 'Large Language Model Deployment', 
    'High Availability Systems', 
    'Content Management Sys', 'Cybersecurity', "Service Level Agreements",
    'ERP', 'Kubernetes', 'UI/UX Design'
  ];