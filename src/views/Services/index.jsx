        ...
        <VStack align="left" width={["100%","container.sm"]}>
                    ...
                    <Box p={5} boxShadow="xl" width="inherit" bg="black" borderRadius='10px'>
                        <Text fontSize="lg" fontWeight="bold" color='gray.200' ml="5em">
                            LevelUp excels in software development and provides customized digital marketing strategies, enhancing your vision with unparalleled value from inception to completion.
                        </Text>
                    </Box>
